        ...
        <div class="lg:w-1/2 md:w-2/3 mx-auto">
          <div class="block flex-wrap -m-2 ">
            ...
            {/* Image */}
              ...
              <div class="p-2 w-full">
                <button  onClick={createRecipe} class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Agregar receta</button>
              </div>
