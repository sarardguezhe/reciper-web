        ...
        <div class="flex flex-wrap -m-4">
          <div class="p-2 lg:w-1/3">
            ...
            <div class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-transparent text-indigo-500 mb-5 flex-shrink-0">
              <img src='https://res.cloudinary.com/dc3pogjef/image/upload/v1693867298/sandwich_454602_3_iq4z7g.png' alt='Descubre'/>
            </div>
          ...
          <div class="p-2 lg:w-1/3">
            <div class=" bg-white bg-opacity-75 px-4 pt-8 pb-12 rounded-xl overflow-hidden text-center relative shadow-xl">
            <div class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-transparent text-indigo-500 mb-5 flex-shrink-0">
              <img src='https://res.cloudinary.com/dc3pogjef/image/upload/v1693867771/brussel-sprouts_8886068_2_lavns9.png' alt='Aprende'/>
            </div>
          ...
          <div class="p-2 lg:w-1/3">
            <div class=" bg-white bg-opacity-75 px-4 pt-8 pb-12 rounded-xl overflow-hidden text-center relative shadow-xl">
            <div class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-transparent text-indigo-500 mb-5 flex-shrink-0">
              <img src='https://res.cloudinary.com/dc3pogjef/image/upload/v1693868001/chat_1519760_m43jbr.png' alt='Conecta'/>
            </div>
